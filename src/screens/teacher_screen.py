...
def teacher_tab_take_attendance():
    ...
    with c3:
        ...
        #     # Voice attendance coming soon - requires audio processing libraries
        #     st.info("🎤 Voice Attendance coming in next update!")
...
def teacher_tab_manage_subjects():
    ...
    if subjects:
        ...
        def delete_btn():
            ...
            st.toast(f"✅ Subject '{sub['name']}' deleted successfully!")
            st.rerun()
